...
<div class="container-fluid">
  <div class="panel-prime">
    ...
    <div class="modal-footer">
            <?php
            if($_SESSION['labIdUser'] == "1039" OR $_SESSION['labIdUser'] == "1"){
              ?>
              <a class="btn btn-primary pull-left" href="#" data-toggle="modal" data-target="#mySeleDepModal">Cambiar Establecimiento de salud</a>
              <?php
            }
            ?>
...
<div class="modal fade" id="mySeleDepModal" role="dialog" aria-labelledby="myModalLabel">
...
$('#mySeleDepModal').on('shown.bs.modal', function () {
  $("#txtIdDep").select2();
});
...
$(document).ready(function () {
  ...
  dTable = $('#tblAtencion').DataTable({
    ...
    "bInfo": true,
    "bFilter": false,
    "sAjaxSource": "tbl_repconsultorio.php", // Load Data
    "language": {
    ...
    "columnDefs": [
      ...
      {"orderable": true, "targets": 5, "searchable": false, "class": "text-center font-weit"},
