...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
		<div class="row">
			<div class="col-sm-6">
				<h3 class="panel-title"><strong>REGISTRO DE RESULTADO DE EXAMENES SOLICITADOS</strong></h3>
			</div>
...
function open_edit(idatencion) {
  window.location = './main_editresultadoprod.php?nroSoli='+idatencion;
}

function open_editvalid(idatencion) {
  window.location = './main_editresultadovalidprod.php?nroSoli='+idatencion;
}

function reg_validresul(idatencion) {
  window.location = './main_regvalidresul.php?nroSoli='+idatencion;
}
...
$(document).ready(function () {
  ...
  dTable = $('#tblAtencion').DataTable({
    ...
    "bInfo": true,
    "bFilter": false,
    "sAjaxSource": "tbl_principallab.php", // Load Data
    "language": {
