...
$rResult = $lab->get_tblDatosProductoEnviados($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
...
foreach ($rResult as $aRow) {
    ...
    $btnAnular = '<button type="button" class="btn btn-danger btn-xs" onclick="imprime_ticket(\'' . $aRow['id'] . '\');"><i class="fa fa-remove"></i></button>';
    ...
    $output['aaData'][] = array(
        ...
        "cnt_dia"    => $aRow['cnt_dia'],
        "btn_anular"  => $btnAnular
    );
}
