...
<script Language="JavaScript">
  ...
  function verDetalleAtencion(id) {
    ...
    $.post("../../controller/ctrlLab.php", { id: id, accion: 'POST_DETALLE_EXAMEN_ENVIADO'}, function(data){
      if (data){
...
var dTableP = $('#tbl_aceptados').DataTable({
    ...
    columnDefs: [
        { targets: 0, className: "text-center" }, // botones
        { targets: 1, className: "text-center small text-bold" }, // nro_atencion
        { targets: 2, className: "small" },             // paciente
        { targets: 3, className: "small" }, // dependencia
        { targets: 4, className: "text-center small" }, // fecha toma
        { targets: 5, className: "text-center small" }, // fecha envío
        { targets: 6, className: "text-center small" }, // fecha recibe
        { targets: 7, className: "fw-bold small" } // estado
    ],
    columns: [
      {
...
var dTableP = $('#tbl_enproceso').DataTable({
    ...
    columnDefs: [
        { targets: 0, className: "text-center" }, // botones
        { targets: 1, className: "text-center text-bold" }, // nro_atencion
        { targets: 2, className: "small" },             // paciente
        { targets: 3, className: "small" }, // dependencia
        { targets: 4, className: "text-center small" }, // fecha toma
        { targets: 5, className: "text-center small" }, // fecha envío
...
var dTableP = $('#tbl_validadas').DataTable({
    ...
    columnDefs: [
        { targets: 0, className: "text-center" }, // nro_atencion
        { targets: 1, className: "text-center text-bold" },             // paciente
        { targets: 2, className: "small" }, // dependencia
        { targets: 3, className: "text-center small" }, // fecha toma
        { targets: 4, className: "text-center small" }, // fecha envío
        { targets: 5, className: "text-center small" }, // fecha recibe
