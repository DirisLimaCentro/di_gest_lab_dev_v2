...
$rResult = $lab->get_tblDatosProductoParaDerivar($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
...
foreach ($rResult as $aRow) {
    ...
    $row = array($idcod, $nro_atencion, $aRow['nombre_rs'], $aRow['abrev_tipodoc'] . ": " . $aRow['nrodoc'], $aRow['nro_hc'], $aRow['fec_atencion'], $aRow['dias_transcurrido'], $aRow['nom_producto']);
	//$row = array($idcod, "", "", "", "", "", "", "", "","");
    $output['aaData'][] = $row;
}
