...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>Registro de Referencia de Análisis clínico</strong></h3>
    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="input-group input-group-xs">
                      ...
                      <input type="text" name="txtEmailPac" placeholder="@example.com" required="" id="txtEmailPac" onfocus="this.select()" class="form-control" maxlength="50" value="" onkeydown="campoSiguiente('txtNroRefAtencion', event);"/>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="input-group input-group-xs">
                      ...
                      <input type="text" name="txtFechaAten" placeholder="DD/MM/AAAA" required="" id="txtFechaAten" autofocus="" class="form-control" maxlength="10" value="<?php echo date("d/m/Y") ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask onkeydown="campoSiguiente('txtHoraAten', event);"/>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="input-group input-group-xs">
                      ...
                      <input type="text" name="txtHoraAten" placeholder="HH:MM" required="" id="txtHoraAten" onfocus="this.select()" class="form-control" maxlength="5" value="<?php echo date("h:i") ?>" data-inputmask="'mask': '99:99'" onkeydown="campoSiguiente('txtPesoPac', event);"/>
                    </div>
                  </div>
                </div>
              </div>
...
function hide_paciente(){
  ...
  $("#lblTipDoc").text($("#txtIdTipDoc option:selected" ).text());
  $("#lblNroDoc").val($("#txtNroDoc" ).val());
  $("#lblNomApe").val($("#txtPriApePac" ).val() + ' ' + $("#txtSegApePac" ).val() + ' ' + $("#txtNomPac" ).val());
  $("#lblNroHC").val($("#txtNroHC" ).val());
  $("#lblDatosAten").val($("#txtFechaAten" ).val() + ' (' + $("#txtHoraAten" ).val() + ')');
  $('#showPacienteModal').modal('hide');
};
...
function validForm() {
  ...
  if (txtIdTipDoc == "1") {
    if (txtNroDocLn != 8) {
      msg += "Ingrese el Nro. de documento del Paciente correctamente<br/>";
      sw = false;
    }
  } else if(txtIdTipDoc == "2" || txtIdTipDoc == "4"){
    if (txtNroDocLn <= 5) {
  ...
  if (txtNroHC == "") {
    msg += "Ingrese el Nro. de Historia Clínica del Paciente<br/>";
    sw = false;
  }
  if (txtNomPac == "") {
  ...
  if (txtNroTelFijoPac == "") {
    if (txtNroTelMovilPac == "") {
      msg += "Ingrese el Nro. de Telefono fijo o móvil del paciente<br/>";
      sw = false;
    }
  }
  ...
  if (txtNroRefAtencion == "") {
    msg += "Ingrese el número de FUA<br/>";
    sw = false;
  }
  if (txtFechaAten == "") {
  ...
  if((txtIdCpt == null) || (txtIdCpt == "")){
    msg += "Seleccione al menos un PROCEDIMIENTO LABORATORIO solicitado<br/>";
    sw = false;
  }else {
    ...
    callback: function (result) {
      if (result == true) {
        ...
        $.ajax( {
          ...
          + "&txtNroRefAtencion=" + $('#txtNroRefAtencion').val() + "&txtIdTipAtencion=" + $('#txtIdTipAtencion').val() + "&txtIdDepRef=" + $('#txtIdDepRef').val() + "&txtNroRefDep=" + $('#txtNroRefDep').val() + "&txtCodSIS=" + $('#txtCodSIS').val() + "&txtNroSIS=" + $('#txtNroSIS').val() + "&txtIdGestante=" + $('#txtIdGestante').val() + "&txtFechaParto=" + $('#txtFechaParto').val() + "&txtEdadGest=" + $('#txtEdadGest').val() +"&txtFechaAten=" + $('#txtFechaAten').val() + "&txtHoraAten=" + $('#txtHoraAten').val() + "&txtIdCpt=" + selectednumbers + "&txtPesoPac=" + $('#txtPesoPac').val() + "&txtTallaPac=" + $('#txtTallaPac').val() + "&txtPAPac=" + $('#txtPAPac').val()
          + "&txtTipIng=S&accion=POST_ADD_SOLIATENCION",
