...
.box.box-info {
  border-top-color: #fdc500 !important;
}
.box.box-primary {
  border-top-color: #fdc500 !important;
}
...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>REGISTRO DE ATENCION - INMUNOLOGÍA</strong></h3>
    </div>
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="box box-info">
              ...
              <div class="box-body">
				<?php include '../lab/main_reglab_dato_personal.php'?>
              </div>
            </div>
              ...
              <div class="box-body">
                ...
                <div class="row">
				  <div class="col-sm-12 col-sm-8 col-md-8">
                    ...
                    <?php $rsD = $d->get_listaDepenInstitucionCompleto(); ?>
				  ...
				  <div class="form-group col-sm-4 col-md-4">
					<label for="txtNroAteManual"><small>Código sistema externo:</small></label>
                  ...
                  <div class="form-group col-sm-4 col-md-3">
                    ...
                    <select class="form-control input-lg" name="txtIdPlanTari" id="txtIdPlanTari" onkeydown="campoSiguiente('txtFechaAten', event);" disabled>
                      ...
                      foreach ($rsTa as $rowTa) {
                        echo "<option value='" . $rowTa['id_plan'] . "#" . $rowTa['check_precio'] . "'"; echo ">" . $rowTa['nom_plan'] . "</option>";
                      }
                      ?>
                    </select>
                  </div>
				  <div class="form-group col-sm-4">
                    <label for="txtFechaTomaMuestra">Fecha toma de muestra procedencia<span class="text-danger">(*)</span>:</label>
				...
				<div class="row">
				  <div class="col-sm-12">
					<select class="form-control" name="txtIdProducto" id="txtIdProducto" style="width: 100%" disabled>
					  ...
					  <?php
					  $rsP = $p->get_listaProductoLaboratorioPorIdDepAndIdTipoProducto($labIdDepUser, 3);
					  foreach ($rsP as $rowP) {
...
<script src="main_regsolicitudreferenciada.js?v=<?php echo rand(); ?>"></script>
...
function campoSiguiente(campo, evento) {
  if (evento.keyCode == 13 || evento.keyCode == 9) {
    if (campo == 'btnPacSearch') {
      buscar_datos_personales('reglaboratorioref');
    } else if (campo == 'btnSoliSearch') {
      buscar_datos_personalessoli('reglaboratorioref');
