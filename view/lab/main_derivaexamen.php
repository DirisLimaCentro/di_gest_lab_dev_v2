...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>DERIVAR EXAMEN A OTRO LABORATORIO</strong></h3>
    </div>
      ...
      <div class="row">
              ...
              <table id="tblSolicitud" class="display" cellspacing="0" width="100%">
                <thead class="bg-primary">
                  <tr>
                    ...
                    <th><small>Laboratorio destino</small></th>
					<th><small>Examen enviado</small></th>
		...
		<div class="col-sm-2">
          <div>
              ...
              <div class="row">
                <button class="btn btn-default btn-sm" id="btnBack" type="button" onclick="back();" tabindex="1"><i class="glyphicon glyphicon-log-out"></i> Ir al inicio</button>
              </div>
          </div>
        </div>
		</div>
...
*/
  ...
  function print_validados(idEnv) {
    var urlwindow = "../labrefen/pdf_laboratorio_psa.php?id_envio=" + idEnv;
    day = new Date();
    id = day.getTime();
  ...
  function open_detalle(idEnv) {
    var urlwindow = "../labrefen/pdf_regenvio.php?idEnv=" + idEnv;
    day = new Date();
    id = day.getTime();
    Xpos = (screen.width / 2) - 390;
    Ypos = (screen.height / 2) - 300;
  ...
  $(document).ready(function () {
	...
	var dTableS = $('#tblSolicitud').DataTable({
		...
		"bInfo": true,
		"bFilter": false,
		"sAjaxSource": "tbl_derivadoenv.php", // Load Data
		"language": {
	...
	"bInfo": true,
	"bFilter": false,
	"sAjaxSource": "tbl_principalsolienvPro.php", // Load Data
	"language": {
	"url": "../../assets/plugins/datatables/Spanish.json",
	"lengthMenu": '_MENU_ entries per page',
	"search": '<i class="fa fa-search"></i>',
	...
	"fnServerParams": function (aoData)
	{
		aoData.push({"name": "idDepRef", "value": ''});
		aoData.push({"name": "id_estado", "value": '2'});
		aoData.push({"name": "opt", "value": 'EESS'});
	},
