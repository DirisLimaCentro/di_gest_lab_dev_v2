		...
		<div class="panel panel-success">
		  ...
		  <div class="panel-body">
			...
			<fieldset class="scheduler-border">
			  ...
			  <div class="form-group">
				<label class="radio-inline"><input type="radio" class="opt_lactancia" name="txtLactancia" id="txtLactancia1" value="1"/>Recibio</label>
				<label class="radio-inline"><input type="radio" class="opt_lactancia" name="txtLactancia" id="txtLactancia0" value="0"/>No recibio</label>
			  </div>
			  <div>
				<label for="">Entrega de Leche Succedánea:</label>
				<div class="row">
					<div class="col-sm-4">
					  <div class="form-group">
						<label for="txt_entregamessuccedanea"># Mes de entrega</label>
						<select name="txt_entregamessuccedanea" id="txt_entregamessuccedanea" class="form-control">
						  <option value="">Seleccione</option>
						  <option value="1">1er mes</option>
						  <option value="2">2do mes</option>
						  <option value="3">3er mes</option>
						  <option value="4">4to mes</option>
						  <option value="5">5to mes</option>
						  <option value="6">6to mes</option>
						  <option value="7">7mo mes</option>
						  <option value="8">8vo mes</option>
						  <option value="9">9no mes</option>
						  <option value="10">10mo mes</option>
						  <option value="11">11vo mes</option>
						  <option value="12">12vo mes</option>
						</select>
					  </div>
					</div>
					<div class="col-sm-4">
					  <label for="txt_fecentregamessuccedanea">Fecha entrega</label><br/>
						<input type="text" name="txt_fecentregamessuccedanea" id="txt_fecentregamessuccedanea" class="form-control" maxlength="10" value="" onfocus="this.select()" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask onkeydown="campoSiguiente('txt_nro_latasentregamessuccedanea', event);" disabled/>
					</div>
					<div class="col-sm-4">
					  <label for="txt_nro_latasentregamessuccedanea"># latas</label><br/>
						<input type="text" name="txt_nro_latasentregamessuccedanea" id="txt_nro_latasentregamessuccedanea" class="form-control" maxlength="10" value="" onfocus="this.select()"/>
					</div>
			  </div>
			  </div>
			</fieldset>
