...
function save_atencion() {
  //$('#btnValidForm').prop("disabled", true);
	...
	var id_notrataadecuado = document.frmSolicitud.txt_notrataadecuado.value;
      ...
      if (result == true) {
        ...
        $.ajax( {
          ...
          data: {
			...
			//Datos observacion de madre y culminacion de embarazo
			obs_madre: document.frmSolicitud.txtObsMadre.value, id_tipoculminaembarazo: id_tipoculminaembarazo, id_tipoparto: id_tipoparto, fec_partootro:fec_partootro,
			//Datos del menor
