...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>Registro de Transmisión Materno Infantil - SÍFILIS MATERNA</strong></h3>
    </div>
    ...
    <legend class="scheduler-border">Buscar atención</legend>
      ...
      <p class="text-right" style="margin: 0 0 0px;"><b>Acciones</b>: <a style="color: #449d44;"><i class="glyphicon glyphicon-pencil"></i></a>=Editar Atención o continuar con seguimiento | <a style="color: #00c0ef;"><i class="glyphicon glyphicon-eye-open"></i></a>=Exportar padron nominal | <a style="color: #449d44;"><i class="glyphicon glyphicon-repeat"></i></a>=Inicar otro seguimiento</p>
      <br/>
      <table id="tblSolicitud" class="display" cellspacing="0" width="100%">
        <thead class="bg-aqua">
          <tr>
            ...
            <th>H. CL. <br/>DEPENDENCIA</th>
			<th>TIPO<br/>PACIENTE</th>
            <th>DEPENDENCIA<br/>ORIGEN</th>
			<th>DEPENDENCIA<br/>ACTUAL</th>
			<th>PRÓXIMA<br/>CITA</th>
  ...
  function reg_solicitud() {
    window.location = './reg_sifilis.php';
  }
  function edit_solicitud(id) {
    window.location = './reg_sifilis.php?id='+id;
  }
  ...
  $(document).ready(function () {
    ...
    var dTable = $('#tblSolicitud').DataTable({
      ...
      "bInfo": true,
      "bFilter": false,
      "sAjaxSource": "tbl_sifilis.php", // Load Data
      "language": {
      ...
      "columnDefs": [
        ...
        {"orderable": false, "targets": 3, "searchable": false, "class": "small font-weit"},
        {"orderable": false, "targets": 4, "searchable": false, "class": "small font-weit"},
		{"orderable": false, "targets": 5, "searchable": false, "class": "small"},
		{"orderable": false, "targets": 6, "searchable": false, "class": "small font-weit"},
