<div class="row">
	...
	<div class="panel panel-success">
	  <div class="panel-heading">
		<h3 class="panel-title"><strong>ESTADO DEL MENOR 1</strong></h3>
	  </div>
	  <div class="panel-body" style="padding-top: 11px !important;">
		<div class="form-group">
			<label class="radio-inline"><input type="radio" class="opt_tipoCulmiEmbarazoNino" name="txt_tipoCulmiEmbarazoNino" id="txt_tipoCulmiEmbarazoNino1" value="1"/><b>Parto</b></label>
			<label class="radio-inline"><input type="radio" class="opt_tipoCulmiEmbarazoNino" name="txt_tipoCulmiEmbarazoNino" id="txt_tipoCulmiEmbarazoNino2" value="2"/><b>Mortinato u Óbito Fetal</b></label>
		</div>
