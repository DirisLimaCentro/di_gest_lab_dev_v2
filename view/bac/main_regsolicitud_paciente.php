<div class="col-sm-4">
	<div class="panel panel-info">
	  <div class="panel-heading">
		<h3 class="panel-title"><strong>3.1 Datos de la paciente</strong></h3>
	  </div>
				...
				<div class="col-sm-8" style="padding-left: 0!important;">
				  <div class="input-group input-group">
					...
					<div class="input-group-btn">
					  <button class="btn btn-info" type="button" id="btnPacSearch" onclick="valid_atencion_anterior()" disabled><i class="fa fa-search"></i></button>
					</div>
				  </div>
				</div>
			  </div>
...
<div class="col-sm-4">
	<div class="panel panel-info">
	  <div class="panel-heading">
		<h3 class="panel-title"><strong>3.2 Notificación de la paciente</strong></h3>
	  </div>
	  <div class="panel-body">
		<div class="form-group">
