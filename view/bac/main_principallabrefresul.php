...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>Registro de resultado de investigación bacteriológica</strong></h3>
    </div>
  ...
  $(document).ready(function () {
    ...
    "fnServerParams": function (aoData)
    {
	  ...
	  aoData.push({"name": "id_tipprocedimiento", "value": "2"});
  ...
  "columnDefs": [
    {"orderable": false, "targets": 0, "searchable": false, "class": "font-weit text-center"},
    {"orderable": false, "targets": 1, "searchable": false, "class": ""},
    ...
    {"orderable": false, "targets": 6, "searchable": false, "class": "font-weit text-center"},
...
function reg_resultado(id) {
  window.location = './main_regresultadolabref.php?nroSoli='+id;
}
