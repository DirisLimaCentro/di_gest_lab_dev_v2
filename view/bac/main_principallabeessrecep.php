...
<div class="container-fluid">
      ...
      callback: function (result) {
        if (result == true) {
          ...
          $.ajax( {
            ...
            data: {
              accion: 'POST_ADD_REGENVIORECEPCIONLABEESS', txtIdEnv: txtIdEnv,
              rand: myRand,
            },
  ...
  $(document).ready(function () {
    ...
    var dTable = $('#tblSolicitud').DataTable({
      ...
      "bInfo": true,
      "bFilter": false,
      "sAjaxSource": "tbl_principallabeessrecepPen.php", // Load Data
      "language": {
      ...
      "fnServerParams": function (aoData)
      {
		...
		aoData.push({"name": "id_servicio_origen", "value": "1"});
      },
      "columnDefs": [
