...
<div class="container-fluid">
      ...
      <div class="row">
          ...
          <form class="form-horizontal" name="frmRepPrin" id="frmRepPrin" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="input-group input-group-sm">
                      ...
                      <input type="text" name="txtBusNroDoc" placeholder="Número de documento" required="" id="txtBusNroDoc" class="form-control input-sm" maxlength="8" onkeydown="campoSiguiente('btn-pac-search', event);"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-5 col-md-5">
                ...
                <input class="form-control input-sm" type="text" name="txtBusNomRS" id="txtBusNomRS" autocomplete="OFF" maxlength="50" required="" tabindex="0">
              </div>
              ...
              <ul>
                <li>
                  ...
                  <ul class="list-unstyled">
                    <li><button class="btn btn-success btn-xs" style="cursor: default;"><i class="glyphicon glyphicon-eye-open"></i></button></li>
                  </ul>
                </li>
              </ul>
              <p><b>Botones de acci&oacute;n:</b></p>
              <div class="row">
                <button class="btn btn-primary btn-sm" style="margin-bottom: 15px;" onclick="reg_solicitud()"><i class="glyphicon glyphicon-plus"></i> Registrar Solicitud</button>
              </div>
            </small>
          </div>
        </div>
		...
		<table id="tblAtencion" class="display" cellspacing="0" width="100%">
			<thead class="bg-green">
			  <tr>
			    <th><small>Nro.<br/>Solicitud</small></th>
				<th><small>Documento Pac.</small></th>
				<th><small>HC</small></th>
				<th><small>Paciente</small></th>
				<th><small>Profesional de salud</small></th>
				<th><small>Fecha<br/>Solicitud</small></th>
				<th><small>Fecha<br/>Finalizado</small></th>
				<th><small>Estado Solicitud</small></th>
				<th><small>&nbsp;</small></th>
			  </tr>
			</thead>
			<tbody>
  ...
  $(document).ready(function () {
    ...
    "fnServerParams": function (aoData)
    {
      ...
      aoData.push({"name": "idFuenQueja", "value": $("#txtIdBusFuenQueja").val()});
  ...
  "columnDefs": [
    {"orderable": false, "targets": 0, "searchable": false, "class": "small text-center"},
...
function open_pdfsolisinvalor(idSoli) {
