...
$rResult = $ba->get_tblDatosEnvSolicitud($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
$rResultFilterTotal = $ba->get_tblCountEnvSolicitud($sWhere, $param);
/* echo $rResultFilterTotal."Jose";
  exit(); */
list($iFilteredTotal) = $rResultFilterTotal;
$rResultTotal = $ba->get_tblCountEnvSolicitud($sWhere, $param);
