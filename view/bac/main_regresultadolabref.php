...
$rsR1 = $ba->get_datosResultado($idAtencion,2);
//print_r($rsR1);
?>
	  ...
	  <div class="col-sm-3">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
                  <label for="txtNroBaarBacilo"><b>N° Colonias:</b></label>
    ...
    callback: function (result) {
      if (result == true) {
        ...
        $.ajax( {
          ...
          data: {
            accion: 'POST_ADD_REGRESPUESTA', id: document.frmRespuesta.txtIdResul.value, id_atencion: document.frmRespuesta.txtIdSolicitud.value, id_estadovalid: document.frmRespuesta.txtEstResul.value, id_tipprocedimiento: "2",
            ...
            if(tmsg == "OK"){
			  if(id_estadovalid == "2"){
				location.reload();
				  ...
				  window.location = './main_principallabrefresul.php';
			  }
