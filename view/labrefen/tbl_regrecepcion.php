...
foreach ($rResult as $aRow) {
	...
	if($input['id_estado'] == "2"){
		$btnDetSub = ' <a href="#" data-target="#showSubModal" class="delete" data-toggle="tooltip" data-placement="top" title="Subsanar observación" onclick="open_rechazar(\'' . $aRow['id'] . '\', \'' . $aRow['abrev_tipodocpac'].": ".$aRow['nro_docpac'] . '\');"><i class="glyphicon glyphicon-remove"></i></a>';
		$idcod = "";
	}
