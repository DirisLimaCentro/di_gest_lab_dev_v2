...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>Registro de Constancia de ITS</strong></h3>
    </div>
    ...
    <legend class="scheduler-border">Buscar atención</legend>
      ...
      <p class="text-right" style="margin: 0 0 0px;"><b>Acciones</b>: <a style="color: #449d44;"><i class="glyphicon glyphicon-pencil"></i></a>=Editar Atención | <a style="color: #00c0ef;"><i class="glyphicon glyphicon-eye-open"></i></a>=Ver Constancia</p>
      <br/>
      <table id="tblSolicitud" class="display" cellspacing="0" width="100%">
        <thead class="bg-aqua">
          <tr>
            <th>N°<br/>Constancia</th>
  ...
  function reg_solicitud() {
    window.location = './main_regconstancia.php';
  }
