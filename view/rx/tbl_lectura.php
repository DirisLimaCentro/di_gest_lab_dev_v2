...
$rResult = $rx->get_tblDatosLectura($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
$rResultFilterTotal = $rx->get_tblCountLectura($sWhere, $param);
/* echo $rResultFilterTotal."Jose";
exit(); */
list($iFilteredTotal) = $rResultFilterTotal;
$rResultTotal = $rx->get_tblCountLectura($sWhere, $param);
...
foreach ($rResult as $aRow) {
  ...
  $btnLista = ' <a href="#" data-target="#editProductModal" class="lis" data-toggle="tooltip" data-placement="top" title="Lista de archivos" onclick="reg_resultado(\'' . $aRow['id'] . '\');"><i class="glyphicon glyphicon-eject"></i></a>';
  ...
  $row = array($aRow['fec_atencion'],$aRow['nom_depen'],$aRow['nombre_rspac'], $aRow['abrev_tipodocpac'].": ".$aRow['nro_docpac'], $aRow['nombre_profe'], $aRow['nom_tiporx'],$aRow['nom_estadoresul'],$totfile,$btnDet.$btnLista.$btnEli);
  $output['aaData'][] = $row;
}
