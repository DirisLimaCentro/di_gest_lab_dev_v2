...
<div class="container-fluid">
  <div class="panel-prime">
    ...
    <legend class="scheduler-border">Buscar atención</legend>
      ...
      <p class="text-right" style="margin: 0 0 0px;">
        <b>Acciones</b>: <a><i class="glyphicon glyphicon-eject"></i></a>=Registrar resultado | <a style="color: #449d44;"><i class="glyphicon glyphicon-pencil"></i></a>=Editar resultado | <a><i class="glyphicon glyphicon-check"></i></a>=Validar resultados | <a style="color: #00c0ef;"><i class="glyphicon glyphicon-eye-open"></i></a>=Ver ficha de atención
      </p>
      <br/>
  ...
  function reg_resultado(id) {
    window.location = './reg_lectura.php?nroSoli='+id;
  }
  ...
  $(document).ready(function () {
    ...
    var dTable = $('#tblSolicitud').DataTable({
      ...
      "bFilter": false,
      "ordering": false,
      "sAjaxSource": "tbl_lectura.php", // Load Data
      "language": {
