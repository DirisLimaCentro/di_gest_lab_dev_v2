...
$sIndexColumn = 'cpt.denominacion_cpt';
...
if (!empty($aOrderingRules)) {
    ...
    $sOrder = " Orde By cpt.denominacion_cpt";
}
...
$rResult = $cpt->get_tblDatosCpt($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
$rResultFilterTotal = $cpt->get_tblCountCpt($sWhere, $param);
/* echo $rResultFilterTotal."Jose";
  exit(); */
list($iFilteredTotal) = $rResultFilterTotal;
$rResultTotal = $cpt->get_tblCountCpt($sWhere, $param);
...
foreach ($rResult as $aRow) {
    ...
    $btnEdit = '<button class="btn btn-success btn-xs" onclick="edit_registro(\'' . $aRow['id_cpt'] . '\');"><i class="glyphicon glyphicon-pencil"></i></button>';
    ...
    $row = array($aRow['id_cpt'], $aRow['denominacion_cpt'], $nomEstado, $btnEdit);
    $output['aaData'][] = $row;
}
