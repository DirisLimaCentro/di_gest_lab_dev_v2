...
<div class="container">
        ...
        <div class="col-sm-2">
          <div>
            <small>
              ...
              <div class="row">
                <button class="btn btn-primary btn-sm" style="margin-bottom: 15px;" onclick="reg_analisis()"><i class="glyphicon glyphicon-plus"></i> Registrar UPS</button>
              </div>
              <div class="row">
  ...
  $(document).ready(function () {
    ...
    "bInfo": true,
    "bFilter": false,
    "sAjaxSource": "tbl_principalups.php", // Load Data
    "language": {
      //"url": "../plugins/datatables/Spanish.json",
