...
$aColumns = array('cpt.id_cpt', 'cpt.denominacion_cpt', '', ''); //Kolom Pada Tabel
// Indexed column (used for fast and accurate table cardinality)
$sIndexColumn = 'cpt.id_cpt';
...
$rResult = $c->get_tblDatosCpt($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
$rResultFilterTotal = $c->get_tblCountCpt($sWhere, $param);
/* echo $rResultFilterTotal."Jose";
  exit(); */
list($iFilteredTotal) = $rResultFilterTotal;
$rResultTotal = $c->get_tblCountCpt($sWhere, $param);
...
foreach ($rResult as $aRow) {
    ...
    $btnGrupo = '<button class="btn btn-success btn-xs" onclick="open_comp(\'' . $aRow['id_cpt'] . '\',\'' . $aRow['denominacion_cpt'] . '\');"><i class="glyphicon glyphicon-list-alt"></i></button>';

    $row = array($aRow['id_cpt'], $aRow['denominacion_cpt'], $aRow['cnt_comp'], $btnGrupo);
    $output['aaData'][] = $row;
}
