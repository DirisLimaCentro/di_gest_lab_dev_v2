...
*/
    ...
    $this->Cell(9, 4, utf8_decode('Le-'), 'LTR', 0, 'C', false);
    ...
    $this->Cell(9, 4, utf8_decode('sión'), 'LBR', 0, 'C', false);
    $this->Cell(16, 4, utf8_decode('N° Lamina'), 'LBR', 0, 'C', false);
    $this->Cell(24, 4, utf8_decode('Resultado'), 'LBR', 1, 'C', false);
...
foreach ($rsC as $row) {
  ...
  $pdf->Cell(9, 4, utf8_decode(''), 'LBR', 0, 'C', false);
  $pdf->SetFont('Arial','B',7);
  $pdf->Cell(16, 4, utf8_decode($row['nro_reglab']), 'LBR', 0, 'C', false);
