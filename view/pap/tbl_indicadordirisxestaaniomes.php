...
$aColumns = array('mes_atencion', '', '', '', '', ''); //Kolom Pada Tabel
// Indexed column (used for fast and accurate table cardinality)
$sIndexColumn = 'mes_atencion';
...
$rResult = $pap->get_tblDatosIndiDirisPorEstablecimientoAndAnioMesAtencion($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
/*
...
foreach ($rResult as $aRow) {
  ...
  $row = array($aRow['nommes_atencion'], number_format($aRow['muestra']), number_format($aRow['negativo']), number_format($aRow['positivo']), number_format($aRow['insatisfactorio']), number_format($aRow['rechazado']), number_format($aRow['entregadoapac']));
  $output['aaData'][] = $row;
}
