...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2', utf8_encode('AÑO: ' . $_GET['anio'] . ' MES: ' . $_GET['mes']));
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A3', '');
$objPHPExcel->getActiveSheet()->mergeCells('A1:N1');
$objPHPExcel->getActiveSheet()->mergeCells('A2:N2');
$objPHPExcel->getActiveSheet()->getStyle('A1:N1')->applyFromArray($styleTituloPrincipal);
$objPHPExcel->getActiveSheet()->getStyle('A2:N2')->applyFromArray($styleTituloPrincipal);

$objPHPExcel->setActiveSheetIndex(0)
->setCellValue('A4', utf8_encode('#'))
->setCellValue('B4', utf8_encode('ESTABLECIMIENTO'))
->setCellValue('C4', 'DOC. IDENTIDAD')
->setCellValue('D4', utf8_encode('NRO. DOCUMENTO'))
->setCellValue('E4', 'NOMBRE PACIENTE')
->setCellValue('F4', 'EDAD')
->setCellValue('G4', 'H. CLINICA')
->setCellValue('H4', 'TIPO PAC.')
->setCellValue('I4', utf8_encode('DISTRITO'))
->setCellValue('J4', utf8_encode('TELEFONO'))
->setCellValue('K4', utf8_encode('FECHA TOMA'))
->setCellValue('L4', utf8_encode('FECHA RESULTADO'))
->setCellValue('M4', utf8_encode('RESULTADO'))
->setCellValue('N4', utf8_encode('FECHA ENTREGA A PAC.'));
$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacionTitulo, "A4:N4");

$param[0]['anio'] = $_GET['anio'];
$param[0]['mes'] = $_GET['mes'];
$param[0]['id_dependencia'] = $_GET['id_dependencia'];
$param[0]['id_estado'] = $_GET['id_estado'];
...
header('Content-Disposition: attachment;filename="reporte_detalle_PAP.xls"');
