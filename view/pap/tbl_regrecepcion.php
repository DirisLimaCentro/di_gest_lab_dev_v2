...
$aColumns = array('pap.id_papsoli', 'pap.id_papsoli', 'pap.id_papsoli', '', '', '', '', '', '', '', '', ''); //Kolom Pada Tabel
...
foreach ($rResult as $aRow) {
    ...
    $idcod = $aRow['id_papenviodet'];
    $row = array($idcod, $aRow['nro_reglab'], $aRow['nro_ordensoli']."-".$aRow['anio_ordensoli'], $aRow['abrev_rspac'].$priNomFalle.$otroNomFalle, $aRow['nombre_rspac'], $aRow['abrev_tipodocpac'] . ": " . $aRow['nro_docpac'], $aRow['fec_atencion'], $aRow['dias_transcurrido'], $btnDet);
    $output['aaData'][] = $row;
}
