...
foreach ($rResult as $aRow) {
    ...
    $btnDet = '<button class="btn btn-success btn-xs" onclick="open_pdfsinvalor(\'' . $aRow['id_papsoli'] . '\');"><i class="glyphicon glyphicon-eye-open"></i></button>';
    switch ($aRow['nom_resul']) {
      case 'value':
        // code...
        break;
    ...
    $row = array($aRow['fec_paprecep'],  $aRow['nom_depen'], $aRow['nom_resul'], trim($aRow['nom_bethesa']), $aRow['nro_reglab'].$anioLab, $aRow['fec_resul'], $aRow['fec_papfinal'], $btnDet);
    $output['aaData'][] = $row;
}
