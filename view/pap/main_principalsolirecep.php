...
<div class="container-fluid">
  <div class="panel-prime">
    <div class="panel-heading">
      <h3 class="panel-title"><strong>Recepcionar, clasificar y finalizar envíos de muestras de PAP</strong></h3>
    </div>
    <div class="panel-body">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <p class="text-right" style="margin: 0 0 0px;"><b>Acciones</b>: <span style="color: #00c0ef;"><i class="glyphicon glyphicon-eye-open"></i></span>=Ver planilla de envío | <span style="color: #449d44;"><i class="glyphicon glyphicon-ok"></i></span>=Recepcionar Envío</p>
          <table id="tblSolicitud" class="display" cellspacing="0" width="100%">
            <thead class="bg-primary">
              <tr>
				...
				<th>Fec. Recep<br/>DIRIS</th>
				<th>Fec. Envío<br/>DIRIS a Lab.</th>
      ...
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <p class="text-right" style="margin: 0 0 0px;"><b>Acciones</b>: <span style="color: #00c0ef;"><i class="glyphicon glyphicon-eye-open"></i></span>=Ver planilla de envío | <span style="color: #449d44;"><i class="glyphicon glyphicon-ok"></i></span>=Aceptar, observar o rechazar muestras pendientes de recepción | <span style="color: #449d44;"><i class="glyphicon glyphicon-ok-sign"></i></span>=Finalizar envío | <span style="color: #F44336;"><i class="glyphicon glyphicon-refresh"></i></span>=Volver a enumerar envío<br/><span class="text-primary"><i class="fa fa-hand-o-up"></i></span>=Volver envío a bandeja de recepción</p>
          <table id="tblEnProceso" class="display" cellspacing="0" width="100%">
            <thead class="bg-aqua">
              <tr>
                <th>Fec.<br/>Recepción<br/>Lab.</th>
                <th>Establecimiento<br/>Procedencia</th>
                <th>N° Envío</th>
...
<div class="modal fade" id="showDetEnvModal" role="dialog" aria-labelledby="showDetEnvModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="showDetEnvModalLabel">Detalle fechas de envío <span id="lbl_nroenv"></span></h4>
        </div>
        <div class="modal-body">
			<b><p id="lbl_eess" class="text-center"></p></b>
			<dl class="dl-horizontal">
				<dt>Envío EESS Procedencia:</dt>
				<dd id="lbl_fec_papenvio">...</dd>
				<dt>Recepción DIRIS:</dt>
				<dd id="lbl_fec_paprecepsede">...</dd>
				<dt>Envío DIRIS a Lab.:</dt>
				<dd id="lbl_fec_papenviosede">...</dd>
				<dt>Recepción Lab.:</dt>
				<dd id="lbl_fec_papreceplab">...</dd>
				<dt>Finalizado:</dt>
				<dd id="lbl_fec_papfinalizado">...</dd>
			</dl>
        </div>
        <div class="modal-footer">
          <div class="row">
  ...
  function det_envio(papenvio,paprecepsede,papenviosede,papreceplab,papfinalizado,nroenv,eess) {
    $('#lbl_fec_papenvio').text(papenvio);
	$('#lbl_fec_paprecepsede').text(paprecepsede);
	$('#lbl_fec_papenviosede').text(papenviosede);
	$('#lbl_fec_papreceplab').text(papreceplab);
	$('#lbl_fec_papfinalizado').text(papfinalizado);
	$('#lbl_nroenv').text('N° Envío: ' + nroenv);
	$('#lbl_eess').text(eess);

    $('#showDetEnvModal').modal({
      show: true,
      backdrop: 'static',
      focus: true,
    });
      ...
      callback: function (result) {
        if (result == true) {
          ...
          $.ajax( {
            ...
            data: {
              accion: 'POST_ADD_REGENVIORECEPCION', txtIdEnv: txtIdEnv,
              rand: myRand,
            },
  ...
  function save_formfinenv() {
	...
	function regresar_envio(id_envio, nom_dep, nro_envio){
		//$('#btnRBRecibidos').prop("disabled", true);
		bootbox.confirm({
			  message: "El envío N° " + nro_envio +" regresará a la Bandeja de Recepción, ¿Estás seguro de continuar?",
			  buttons: {
				confirm: {
				  label: 'Si',
				  className: 'btn-success'
  ...
  $(document).ready(function () {
    ...
    var dTable = $('#tblSolicitud').DataTable({
      ...
      "bInfo": true,
      "bFilter": false,
      "sAjaxSource": "tbl_principalsolirecepPen.php", // Load Data
      "language": {
    ...
    var pTable = $('#tblEnProceso').DataTable({
      ...
      "columnDefs": [
        {"orderable": true, "targets": 0, "searchable": false, "class": "small font-weit text-center"},
