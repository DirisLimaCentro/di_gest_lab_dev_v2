...
$rResult = $pap->get_tblDatosIndiDirisPorEstablecimiento($sWhere, $sOrder, $sLimit, $param);
//print_r($rResult);
/*
...
foreach ($rResult as $aRow) {
  ...
  $row = array($aRow['nom_depen'], number_format($aRow['muestra']), number_format($aRow['negativo']), number_format($aRow['positivo']), number_format($aRow['insatisfactorio']), number_format($aRow['rechazado']), number_format($aRow['entregadoapac']));
  $output['aaData'][] = $row;
}
