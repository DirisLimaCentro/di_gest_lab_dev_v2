...
foreach ($rResult as $aRow) {
    ...
    $btnRec = ' <a href="#" data-target="#editProductModal" class="acept" data-toggle="tooltip" data-placement="top" title="Recepcionar envio" onclick="event.preventDefault(); show_recepcion_manual(\'' . $aRow['id_papenvio'] . '\',\'' . $aRow['nom_depen'] . '\',\'' . $aRow['nro_papenv'] . '\');"><i class="glyphicon glyphicon-ok"></i></a>';

    $row = array($aRow['nom_depen'], $aRow['nro_papenv'], $aRow['fec_papenvio'], $aRow['fec_paprecepsede'], $aRow['fec_papenviosede'], "<span class=\"badge bg-blue\">".$aRow['cnt_solienvtot']."</span>", $btnDet.$btnRec);
    $output['aaData'][] = $row;
}
